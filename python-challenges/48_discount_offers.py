...
"""
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
Munkres import inlined to test with CodeEval
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
"""
...
def build_cost_matrix(names, products):
    """Build a list of lists containing the weights for each of the
    edges in our graph.
    """
    costs = []
    for name in names:
        # we want to calculate the max, so use the negative value of the weight
        costs.append([-weight(name, product) for product in products])
...
# borrowed implementation of euclid gcd from Jordan Rastrick at
# http://bytes.com/topic/python/answers/157067-euclids-algorithm-python
def euclid_gcd(a, b):
    if a < b:
        a, b = b, a
    while b != 0:
...
#this assumes val is already lowercase
